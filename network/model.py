...
def get_model_custom2(input_shape=(75, 75, 3), inputs_meta=1):
    kernel_size = (3, 3)
    ...
    conv3 = BatchNormalization()(conv3)
    conv3 = Activation('relu')(conv3)
    conv3 = MaxPooling2D(pool_size=(2, 2), strides=(1, 1))(conv3)
    conv3 = Dropout(0.3)(conv3)
    # size = 5x5
    ...
    conv4 = BatchNormalization()(conv4)
    conv4 = Activation('relu')(conv4)
    conv4 = MaxPooling2D(pool_size=(2, 2), strides=(1, 1))(conv4)
    conv4 = Dropout(0.3)(conv4)
    # size = 2x2
...
def get_model_fft_dense(input_shape, inputs_meta = None):
    optimizer = Adam(lr = 0.001, decay=0.0)

    input_bands = Input(shape=input_shape, name = 'bands')
    inputs_bands_norm = BatchNormalization()(input_bands)
    dense_1 = Dense(512)(inputs_bands_norm)
